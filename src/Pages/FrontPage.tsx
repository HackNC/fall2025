    ...
    return (
        <div id="FrontPage" className="flex text-center items-center justify-center md:mt-10">
            <div className="flex flex-col text-center items-center font-jersey tracking-widest"
                style={{ gap: "2.5rems" }}>
                <h1 className="text-9xl text-font-sky-blue text-shadow-accent-blue">HACKNC 2025</h1>
                <h3 className="text-2xl text-primary-light">Oct 10-12, 2025 • In-person at UNC Chapel Hill</h3>
