  ...
  return (
    <>
      ...
      >
        ...
        <a
          href="#"
          className="flex items-center gap-3 py-[10px] px-[48px] max-[1132px]:px-[38px]"
          onClick={() => {
            setMobileMenuOpen(false);
            setAboutOpen(false);
        ...
        >
          <img
            src="./HackNC25.svg"
            alt="HackNC Logo"
            className="w-[66px] h-[66px] max-[1132px]:w-[56px] max-[1132px]:h-[56px] max-[455px]:h-[46px] max-[375px]:h-[40px]"
          />
          <h1
        ...
        <div className="flex gap-[10vw]">
          {/* ------------------------------------------------------------
            DESKTOP NAVIGATION ITEMS (visible above md)
           ------------------------------------------------------------ */}
          <nav className="pt-[20px] max-md:hidden">
            <ul className="flex gap-[100px] max-[1132px]:gap-[60px] list-none items-center m-0">
              {/* <li>
              <a
                href="#"
                onClick={() => {
              ...
              <li className="relative">
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      strokeWidth="3"
                      stroke="currentColor"
                      className="w-5 h-5 max-[1132px]:w-4 max-[1132px]:h-4"
                    >
                      <path
                        strokeLinecap="round"
                ...
                >
                  ...
                  >
                    ...
                    {/* Dropdown links */}
                    <ul
                      className="bg-[#E0E6EF] rounded-xl py-3 px-5 text-center min-w-[200px] max-[1132px]:min-w-[180px]"
                      role="menu"
                    >
                      <li className="py-1">
                        <a
